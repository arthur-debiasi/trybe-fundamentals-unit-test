...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle(2).circumference).toBeCloseTo(12.56);//12.56
    ...
    // Nota: eu quebrei esta parte em 3 verificações por causa do arredondamento, pois o toEqual() não parece saber lidar com isso.
  });
});
